...
checkpoint_dir = 'cross/3k2023to3kperp'
...
for session in range(0,1):
    ...
    aigc_train_loader = set_dataset_aigc_2023('../Database/AIGCIQA2023/AIGCIQA2023_All.csv', bs, '../data/AIGCIQA2023/', num_workers, preprocess3, train_patch, False) 
    aigc_val_loader = set_dataset_aigc_3k('../Database/AGIQA-3K/AIGC-3K_All.csv', bs , '../data/AGIQA-3K', num_workers, preprocess2, test_patch, True)
